...
const Navbar = () => {
  ...
  const handleSignOut = () => {
    ...
    const links =
        <div className='nav-links flex flex-col md:flex-row gap-4 text-white  '>
       ...
       <div className="navbar fixed top-0 z-50 justify-between p-3 w-full bg-[#093672]  shadow-sm">
            <div className="flex">
                <div className="dropdown ">
                    ...
                    <ul
                        tabIndex="-1"
                        className="menu menu-sm dropdown-content bg-[#093672] rounded-box z-1 mt-3 w-52 p-2 shadow">
